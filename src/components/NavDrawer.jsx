...
export function NavDrawer({ onClose, onSelectCategory, onOpenSearch, isLoggedIn, onOpenLogin }) {
  ...
  const DRAWER_SUBSECTIONS = {
    ...
    "Sport": ["Cricket", "Football", "Tennis", "Motorsport", "Athletics", "Badminton"],
    "Technology": ["Artificial Intelligence", "Chips & Silicon", "Cybersecurity", "Gadgets", "Software"],
